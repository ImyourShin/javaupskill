...
public class StudentList {
     ...
     * 
     * 
     * Adds a new course and its grade
     * 
     * @param course the name of the course
     * 
     * @param grade the grade for the course (0-100)
     * 
     */

    public void addCourseGrade(String course, int grade) {
        if (course == null || course.isBlank()) {
            System.out.println("Error:Course name must not be null or blank");
            return;
        }
    ...
    // Print all courses and grades in a formatted string.
