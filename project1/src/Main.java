...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Invoice 1 (Alice): " + String.format("%.2f", invoice1.getAmountAfterDiscount())); // Expected:
                                                                                                              // 500.00
        System.out.println("Invoice 2 (Bob):   " + String.format("%.2f", invoice2.getAmountAfterDiscount())); // Expected:
                                                                                                              // 500 *
                                                                                                              // (1 -
                                                                                                              // 0.15) =
                                                                                                              // 425.00
        System.out.println("Invoice 3 (Charlie): " + String.format("%.2f", invoice3.getAmountAfterDiscount())); // Expected:
                                                                                                                // 1500
                                                                                                                // * (1
                                                                                                                // -
                                                                                                                // 0.10)
                                                                                                                ...
                                                                                                                // (below
                                                                                                                // threshold)
        System.out.println("Invoice 4 (Charlie): " + String.format("%.2f", invoice4.getAmountAfterDiscount())); // Expected:
                                                                                                                // 2500
                                                                                                                // * (1
                                                                                                                // -
                                                                                                                // 0.15)
